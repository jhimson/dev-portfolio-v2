...
const Navbar = () => {
  return (
    <div className="w-full text-white p-8 flex justify-between items-center bg-slate-800">
      <div className="left-nav-items">
        <ul className="flex items-center space-x-8">
          <li className="font-bold text-2xl font-righteous tracking-widest hover:bg-slate-800 px-4 py-2 cursor-pointer rounded text-white hover:scale-125 ease-in-out duration-300">
            Jhimson Pamisa
          </li>
