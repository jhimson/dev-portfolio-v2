    ...
    <div className="image relative w-4/12">
      ...
      <div className="image__overlay image__overlay--blur flex flex-col items-center justify-center absolute top-0 left-0 w-full h-full bg-[rgba(0,0,0,0.6)] opacity-0 hover:opacity-100 ease-in-out duration-300">
        ...
        <div className="flex space-x-8 mt-4">
          ...
          <button className="w-1/2 px-4 py-2 mb-1 font-bold text-white transition duration-200 ease-in-out rounded shadow-lg hover:bg-rose-600 focus:outline-none focus:shadow-outline bg-rose-500 shadow-rose-500/50 hover:scale-110 text-md">Github</button>
        </div>
      </div>
    </div>
  );
